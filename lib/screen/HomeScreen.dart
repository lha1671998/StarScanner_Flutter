    ...
    return SafeArea(
      child: Scaffold(
        ...
        floatingActionButton: Container(
          ...
          child: BlocListener<DocumentsBloc, DocumentState>(
            listener: (context, state) {
              if (state is LoadedState) {
                setState(
                  () {
                    toggle =
                        true; // Close the floating button after a successful addition
                  },
                );
              }
            },
            child: floatingScan(rate),
          ),
        ),
        bottomNavigationBar: bottomNav(rate),
      ),
    );
  }

  Widget floatingScan(double rate) {
    return Stack(
      children: [
        Visibility(
          visible: !toggle,
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        context
                            .read<DocumentsBloc>()
                            .add(const AddDocumentEvent(ImageSource.camera));
                      },
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        context
                            .read<DocumentsBloc>()
                            .add(const AddDocumentEvent(ImageSource.gallery));
                      },
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
